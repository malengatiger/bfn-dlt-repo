package com.bfn.flows.obligation;

import co.paralleluniverse.fibers.Suspendable;
import com.bfn.states.Obligation;
import com.bfn.contracts.ObligationContract;
    ...
    public static class Initiator extends ObligationBaseFlow {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final TransactionBuilder builder = new TransactionBuilder(getFirstNotary())
                    ...
                    .addOutputState(transferredObligation, ObligationContract.OBLIGATION_CONTRACT_ID)
