...
public class BuyInvoiceOfferFlowResponder extends FlowLogic<SignedTransaction> {
    private final static Logger logger = LoggerFactory.getLogger(BuyInvoiceOfferFlowResponder.class);
    private final FlowSession counterPartySession;

    public BuyInvoiceOfferFlowResponder(FlowSession counterPartySession) {
        this.counterPartySession = counterPartySession;
        logger.info("BuyInvoiceOfferFlowResponder Constructor fired: \uD83C\uDF45 \uD83C\uDF45 \uD83C\uDF45");
    }

    @Override
    @Suspendable
    public SignedTransaction call() throws FlowException {
        logger.info("\uD83E\uDD6C \uD83E\uDD6C BuyInvoiceOfferFlowResponder call method at " + new Date().toString());
